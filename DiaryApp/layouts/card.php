        ...
        <div class="flex max-sm:flex-col justify-between gap-y-3 w-full">
                <p class="text-xs self-end">
                    ...
                    <span class="font-semibold text-emerald-600">
                        <?php echo e(date('D d/M/Y h:m A',strtotime($entry['created_at']))); ?>
                    </span>
                </p>
            ...
            <div class="text-lg max-sm:w-full text-white fill-white flex gap-x-2">
                ...
                <a href="<?php echo e('./upload/index.php?'.query('id', $entry['id']))?>" class="bg-yellow-500 p-3  max-sm:w-full  rounded-lg text-center">
